...
class EnvironmentManager {
    ...
    public createGround(): void {
        ...
        this.ground = MeshBuilder.CreateGround('ground1', { width: 120, height: 100 }, this.scene);
        const groundMaterial = new StandardMaterial('groundMat', this.scene);
        groundMaterial.diffuseColor = new Color3(0, 0.5, 0.5);
        ...
        this.surroundingGround = MeshBuilder.CreateGround('ground2', { width: 200, height: 150 }, this.scene);
        const surroundingMaterial = new StandardMaterial('groundMat2', this.scene);
        surroundingMaterial.diffuseColor = new Color3(0, 0.5, 0);
        surroundingMaterial.specularColor = new Color3(0, 0.5, 0);
